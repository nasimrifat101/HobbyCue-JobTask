...
const Testimonial = () => {
    return (
        <div className="vh-100 d-flex justify-content-center align-items-center">
            <div style={{ backgroundColor: '#F7F5F9' }} className="m-5 p-5">
                <div className="d-flex align-items-center gap-4 my-5 p-3">
                    <img src="https://i.postimg.cc/0ykGpmYn/quote.png" alt="" />
                    <h3>Testimonial</h3>
                </div>
                <p className="my-5 fs-5 p-3">
                ...
                <div className='my-5 d-flex justify-content-between align-items-center p-3'>
